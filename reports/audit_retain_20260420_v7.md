...
| F:\ai-ml\agent-memory-cognitive\tests\retain\test_dialogue_action_effect.py | [PASS] | — |
| F:\ai-ml\agent-memory-cognitive\tests\retain\test_dialogue_all_six_types.py | [FAIL] | AssertionError line 137 |
| F:\ai-ml\agent-memory-cognitive\tests\retain\test_dialogue_conference_experience.py | [PASS] | — |
...
| F:\ai-ml\agent-memory-cognitive\tests\retain\test_dialogue_team_collaboration.py | [FAIL] | AssertionError line 111 |
...
### [1] F:\ai-ml\agent-memory-cognitive\tests\retain\test_dialogue_all_six_types.py — FAIL

**Traceback (nguyên văn):**
```text
Traceback (most recent call last):
  File "F:\ai-ml\agent-memory-cognitive\tests\retain\test_dialogue_all_six_types.py", line 137, in <module>
    main()
    ~~~~^^
  File "F:\ai-ml\agent-memory-cognitive\tests\retain\test_dialogue_all_six_types.py", line 132, in main
  ...
  File "C:\Users\admin\AppData\Local\Programs\Python\Python313\Lib\asyncio\base_events.py", line 719, in run_until_complete
    return future.result()
           ~~~~~~~~~~~~~^^
  File "F:\ai-ml\agent-memory-cognitive\tests\retain\test_dialogue_all_six_types.py", line 120, in run_test
    assert found_count >= _MIN_TYPES, (
           ^^^^^^^^^^^^^^^^^^^^^^^^^
AssertionError: Expected at least 4/6 types, got 1/6. Found: {'world'}. Missing: {'opinion', 'experience', 'action_effect', 'intention', 'habit'}
```
...
### [2] F:\ai-ml\agent-memory-cognitive\tests\retain\test_dialogue_team_collaboration.py — FAIL

**Traceback (nguyên văn):**
```text
Traceback (most recent call last):
  File "F:\ai-ml\agent-memory-cognitive\tests\retain\test_dialogue_team_collaboration.py", line 111, in <module>
    main()
    ~~~~^^
  File "F:\ai-ml\agent-memory-cognitive\tests\retain\test_dialogue_team_collaboration.py", line 106, in main
    asyncio.run(run_test())
    ~~~~~~~~~~~^^^^^^^^^^^^
  File "C:\Users\admin\AppData\Local\Programs\Python\Python313\Lib\asyncio\runners.py", line 195, in run
    return runner.run(main)
  ...
  File "C:\Users\admin\AppData\Local\Programs\Python\Python313\Lib\asyncio\base_events.py", line 719, in run_until_complete
    return future.result()
           ~~~~~~~~~~~~~^^
  File "F:\ai-ml\agent-memory-cognitive\tests\retain\test_dialogue_team_collaboration.py", line 92, in run_test
