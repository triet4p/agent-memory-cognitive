...
Một hướng phát triển khác xuất phát trực tiếp từ phân tích định tính ở Chương 4 là làm cho recall nhạy hơn với loại node mà câu hỏi đang cần. Hiện tại CogMem đã có định tuyến truy vấn thích ứng ở mức trọng số giữa các kênh, nhưng hệ thống vẫn chủ yếu truy vấn trên không gian ứng viên rộng, sau đó để RRF và CrossEncoder xếp hạng lại. Các case thành công của CogMem Bench gợi ý rằng trong một số câu hỏi, loại node mục tiêu đã mang phần lớn thông tin quyết định: câu hỏi về kế hoạch chưa hoàn thành thường cần \textit{intention}; câu hỏi về lỗi, hành động sửa và kết quả thường cần \textit{action\_effect}.

Vì vậy, một cải tiến tự nhiên là bổ sung cơ chế recall theo loại node: trước hết nhận diện nhu cầu nhận thức của câu hỏi, sau đó ưu tiên hoặc mở rộng tìm kiếm trên những fact type tương ứng thay vì cào bằng mọi node. Cách này không có nghĩa loại bỏ truy vấn đa kênh, mà là thêm một tầng điều khiển ứng viên trước khi hợp nhất điểm. Ví dụ, truy vấn \textit{prospective} có thể lấy nhiều ứng viên \textit{intention} hơn và theo dõi trạng thái \textit{planning}/\textit{fulfilled}; truy vấn \textit{causal} có thể tăng quota cho \textit{action\_effect} và các cạnh điều kiện--hành động--kết quả. Nếu làm tốt, hệ thống có thể giảm nhiễu, giảm phụ thuộc vào CrossEncoder ở các câu hỏi có tín hiệu loại node rõ ràng, đồng thời tận dụng tốt hơn chính cấu trúc nhận thức đã được lưu trong đồ thị.
