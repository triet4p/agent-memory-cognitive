...
2. [READING-ORDER.md](READING-ORDER.md): catalog ID và 2 lộ trình đọc full-scope (S19.7).
...
- Coverage status hiện tại: `done` cho toàn bộ 58/58 file.
- Status hợp lệ theo quy ước: `not-started`, `in-progress`, `done`.
...
4. Khi cần đọc full-scope, dùng READING-ORDER làm canonical entry thay vì tự gom thứ tự thủ công.