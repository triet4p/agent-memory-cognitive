...
DEFAULT_OUT = REPO_ROOT / "data" / "bench" / "visualizations"
...
def _build_explanation(
    ...
    lines += [
        ...
        "",
        "---",
        f"*Generated by `cogmem_bench/visualize.py` from `data/bench/gate_detail/{sid}.json` + paired banks `COGMEM_BENCH_{sid}_full` / `_ablated`.*",
    ]
    return "\n".join(lines) + "\n"
